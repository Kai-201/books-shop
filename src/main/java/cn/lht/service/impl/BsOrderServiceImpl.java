...
public class BsOrderServiceImpl implements BsOrderService {
     ...
     */
    @Override
    public int deleteById(Integer bsOrderid) {
        return this.bsOrderDao.deleteById(bsOrderid);
    }

    @Override
    public List<BsOrder> selectAllForAdmin() {
        return this.bsOrderDao.selectAllForAdmin();
    }
}