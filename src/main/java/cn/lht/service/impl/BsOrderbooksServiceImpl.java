...
public class BsOrderbooksServiceImpl implements BsOrderbooksService {
     ...
     */
    @Override
    public BsOrderbooks insert(BsOrderbooks bsOrderbooks) {
        this.bsOrderbooksDao.insert(bsOrderbooks);
        return bsOrderbooks;
    }
     ...
     */
    @Override
    public int deleteById(Integer bsOrderbooksid) {
        return this.bsOrderbooksDao.deleteById(bsOrderbooksid);
    }

    @Override
    public List<BsOrderbooks> selectByOrderId(Integer bsOrderId) {
        return this.bsOrderbooksDao.selectByOrderId(bsOrderId);
    }

    @Override
    public int deleteByOrderId(Integer bsOrderId) {
        return this.bsOrderbooksDao.deleteByOrderId(bsOrderId);
    }
}