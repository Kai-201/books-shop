...
public class BsUsers implements Serializable {
    private static final long serialVersionUID = 101620701443910631L;
    /**
    * 自增id
    */
    ...
    * 生日
    */
    private String bsUserbrithday1;
     /**
    * 生日
    */
    ...
    */
    ...
    public String getBsLoginsecret() {
        return bsLoginsecret;
    }

    public void setBsLoginsecret(String bsLoginsecret) {
    ...
    public String getBsUserbrithday1() {
        return bsUserbrithday1;
    }

    public void setBsUserbrithday1(String bsUserbrithday1) {
        this.bsUserbrithday1 = bsUserbrithday1;
    }
