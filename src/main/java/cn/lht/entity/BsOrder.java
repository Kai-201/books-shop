 ...
 *
 * @author makejava
 * @since 2020-04-13 16:10:41
 */
public class BsOrder implements Serializable {
    private static final long serialVersionUID = -23659361643555558L;
    /**
    * 自增Id
    */
    ...
    */
    ...
    private String bsLoginName; // 用于后台视图，非数据库字段
    ...
    public double getBsBooksmoney() {
        return bsBooksmoney;
    }

    public void setBsBooksmoney(double bsBooksmoney) {
    ...
    public Object getBsNeedpay() {
        return bsNeedpay;
    }

    public void setBsNeedpay(Object bsNeedpay) {
