...
public class BsBooks implements Serializable {
    ...
    * 上传者ID
    */
    private Integer bsUploaderid;
    /**
    * 上传者用户名
    */
    private String bsUploadername;
    ...
    public Integer getBsUploaderid() {
        return bsUploaderid;
    }

    public void setBsUploaderid(Integer bsUploaderid) {
        this.bsUploaderid = bsUploaderid;
    }

    public String getBsUploadername() {
        return bsUploadername;
    }

    public void setBsUploadername(String bsUploadername) {
        this.bsUploadername = bsUploadername;
    }
}